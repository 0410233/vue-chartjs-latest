  ...
  <div class="options goods-list-form">
    ...
    >
      <el-form-item label="布局方式">
        <!-- <el-select size="small" v-model="formdata.layout" @change="handleChange($event, 'layout')">
          <el-option value="col1" label="每行一个"></el-option>
          <el-option value="col2" label="每行两个"></el-option>
          <el-option value="list" label="列表模式"></el-option>
        </el-select> -->
...
// import GoodsSelect from './select/GoodsSelect.vue'
