  ...
  <div class="options">
    ...
    >
      ...
      <el-form-item label="添加优惠券">
        <el-radio-group size="mini" v-model="formdata.category" @change="seachList">
          <el-radio :label="1">商家券</el-radio>
          <el-radio :label="2">商品券</el-radio>
        </el-radio-group>
      </el-form-item>
      <div class="view-sort-scroll" ref="view_sort_scroll">
        <draggable tag="div" class="view-sort-list" v-model="formdata.goodsList" v-bind="viewSortDragOptions">
          <div
            v-for="(view, index) in formdata.goodsList"
            :key="index"
          ...
          >
            ...
            <div class="view-sort-item__btn view-sort-item__btn--copy" title="复制" @click="copyView(index)">
              <svg class="view-sort-item__btn-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="view-sort-item__btn view-sort-item__btn--delete" title="移除" @click="deleteView(index)">
              <svg class="view-sort-item__btn-icon" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <div style="margin-bottom: 100px">
      <el-button class="add-link w-full" type="primary" size="small" icon="el-icon-plus" @click="addcoupon"
        >添加优惠券</el-button
      >
    </div>
      ...
      <div class="deco-control-group">
        ...
        <div class="deco-control-group__content">
          <div class="deco-radio-button-group deco-radio-button-group--round">
            <div
              class="deco-radio-button deco-radio-button--active"
              :class="formdata.swiperType === 1 ? 'active' : ''"
              @click="picchange(1)"
            >
              <el-button style="background-color: rgb(231, 76, 44)" circle></el-button>
            </div>
            <div class="deco-radio-button" :class="formdata.swiperType === 2 ? 'active' : ''" @click="picchange(2)">
              <el-button style="background-color: rgb(255, 233, 183)" circle></el-button>
            </div>
            <div class="deco-radio-button" :class="formdata.swiperType === 3 ? 'active' : ''" @click="picchange(3)">
              <el-button style="background-color: rgb(255, 255, 255)" circle></el-button>
            </div>
            <div class="deco-radio-button" :class="formdata.swiperType === 4 ? 'active' : ''" @click="picchange(4)">
            ...
            <div class="deco-radio-button" :class="formdata.swiperType === 5 ? 'active' : ''" @click="picchange(5)">
...
export default {
  ...
  methods: {
    ...
    seachList() {
      ...
      this.getList();
      this.$emit('change', { ['category']: this.formdata.category });
    },
    copyView(index) {
