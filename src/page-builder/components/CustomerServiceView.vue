<template>
  <div class="customer-service-view" @click.stop="$emit('click', $event)" :style="viewStyle">
    <template v-if="isShowIcon">
      <img v-if="customIcon" class="customer-service-view__icon" :src="customIcon" alt="" :style="iconStyle">
    ...
    <span v-if="isShowText" :style="textStyle" class="customer-service-view__text">{{ textValue }}</span>
  </div>
</template>

<script>
import { getProps } from './customer-service'
